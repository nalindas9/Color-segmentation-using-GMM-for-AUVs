"""
Expectation Maximization Algorithm for green buoy segmentation
...
class GmmEm:
  ...
  def e_step(self):
    ...
    for pixel in self.channel:
      # Expectation  of point to lie in Gaussian 1
      ...
      # Expectation  of point to lie in Gaussian 2
      ...
      # Expectation  of point to lie in Gaussian 3
  ...
  # Method to train the EM Algorithm
  def train(self, iterations):
    for i in range(iterations):
      print('Iteration:', i+1)
      for count, pic in enumerate(glob.glob("/home/nalindas9/Documents/Courses/Spring_2020_Semester_2/ENPM673_Perception_for_Autonomous_Robots/Github/project3/Color-segmentation-using-GMM/DATANEW/Green_bouy"+ "/*"), 1):
    ...
    plt.show()
  # Method to test the EM Algorithm
